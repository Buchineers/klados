...
use crate::bp::pricer::exact_pair_dp::collect_corridor_candidates_ref;
use crate::bp::pricer::{Pricer, PricerScratch, PricingContext, PricingResult, dispatch_by_m};
use crate::bp::rmp::{Rmp, RmpSolution};
...
fn lazy_audit_shell(
    ...
    use crate::corridor::lazy_kbest::{LazyKBest, LazyKBestCache, LazyKBestInput};
